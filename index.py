...
def go_back():
   ...
   unbind_ev()
#:::
leftframe = Frame(mainframe, relief=FLAT)
leftframe.pack(fill="both", expand = True, side = LEFT)

wordl = Label(leftframe, textvariable = resultword)
wordl.pack()
#:::
tryf = Frame(leftframe, relief=FLAT)
tryf.pack(fill="both")
#---
gameover = Label(leftframe, text = "Game Over !")
gameover.pack()
#---
...
#:::
#frames :
line1 = Frame(leftframe, relief=FLAT)
line1.pack(fill="both", expand = True)
#---
line2 = Frame(leftframe, relief=FLAT)
line2.pack(fill="both", expand = True)
#---
line3 = Frame(leftframe, relief=FLAT)
line3.pack(fill="both", expand = True)
#---
line4 = Frame(leftframe, relief=FLAT)
line4.pack(fill="both", expand = True)
#---
line5 = Frame(leftframe, relief=FLAT)
...
#"Go back" button :
backbutt = Button(leftframe, text="Go back", command=go_back)
backbutt.pack(fill="both", expand = True)
#"Restart" button :
backbutt = Button(leftframe, text="Restart", command=run)
backbutt.pack(fill="both", expand = True)
#===
